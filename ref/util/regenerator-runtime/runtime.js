...
! function(r) {
  ...
  var g = p.prototype = s.prototype = Object.create(d);
        ...
        return new Promise((function(e, a) {
          ! function e(o, i, a, c) {
            ...
            if ("throw" !== u.type) {
              var f = u.arg,
                s = f.value;
              return s && "object" === t(s) && n.call(s, "__await") ? Promise.resolve(s.__await).then((function(t) {
                e("next", t, a, c)
              }), (function(t) {
                e("throw", t, a, c)
  ...
  l.prototype = g.constructor = p, p.constructor = l, p[c] = l.displayName = "GeneratorFunction", r.isGeneratorFunction = function(t) {
  ...
  }, m(w.prototype), w.prototype[a] = function() {
    return this
  }, r.AsyncIterator = w, r.async = function(t, e, n, o) {
    var i = new w(u(t, e, n, o));
    return r.isGeneratorFunction(e) ? i : i.next().then((function(t) {
      return t.done ? t.value : i.next()
    }))
  }, m(g), g[c] = "Generator", g[i] = function() {
    return this
  }, g.toString = function() {
